...
public class PatientDashboardController extends BaseController implements Initializable {
    ...
    /**
     * Returns a list of all patients in the DB
     * @return patients
     */
    public FindIterable<Document> getPatients() {
     ...
     * @param id (String) patient _id generated by DB
     * @return patients
     */

    public FindIterable<Document> getPatient(String id) {
        FindIterable result = null;

        try {
            result = collection.find(new Document().append("_id", new ObjectId(id)));
    ...
    public ObservableList<Patient> parsePatientList(FindIterable<Document> result) {
        patientList = FXCollections.observableArrayList();
        
        // TODO: parsePatientList()- Dialogue box if user has not permission to perform CRUD action
        ...
        try {
            ...
            if (result == null) {
                ...
                while (cursor.hasNext()) {
                    ...
                    patient.setGender(doc.get("gender").toString());
    ...
    */
    ...
    public void deleteAction(ActionEvent event) {
        ...
        patientsTableView.getItems().stream().filter((patient) -> (patient.getIsSelected()))
                .forEachOrdered((patient) -> {
